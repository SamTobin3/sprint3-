...
export const getAllPizzas = () => async dispatch => {
  ...
  try {
    ...
    dispatch({ type: "GOT_PIZZAS_SUCCESS", payload: response.data });
  } catch (error) {
    console.log(error);
    dispatch({ type: "GOT_NO_PIZZA_", payload: error });
  }
};
...
export const filterPizzas = (searchkey, category) => async dispatch => {
  ...
  try {
    ...
    dispatch({ type: "WOOO_PIZZA", payload: filteredPizzas });
  } catch (error) {
    dispatch({ type: "NOOO_PIZZA", payload: error });
  }
};
...
export const addPizza = pizza => async dispatch => {
  ...
  try {
    ...
    console.log(response);
    dispatch({ type: "GOT_YOURE_PIE" });
  } catch (error) {
    dispatch({ type: "NO_PIZZA_FOR_YOU", payload: error });
  }
};
...
export const deletePizza = pizzaid => async dispatch => {
  try {
    ...
    alert("OH god its happening again");
    console.log(error);
  }
};
